...
implements ComponentSerializer<Component, Component, Object> {
    ...
    public Component deserialize(@NotNull Object input) {
        ...
        try {
            ...
            if (TEXT_SERIALIZER_SERIALIZE_TREE != null) {
                ...
                if (MC_TEXT_GSON == null) return BukkitComponentSerializer.gson().deserialize((Object)TEXT_SERIALIZER_SERIALIZE.invoke(input));
    ...
    public Object serialize(@NotNull Component component) {
        ...
        if (TEXT_SERIALIZER_DESERIALIZE_TREE != null || MC_TEXT_GSON != null) {
            ...
            try {
                if (TEXT_SERIALIZER_DESERIALIZE_TREE == null) return ((Gson)MC_TEXT_GSON).fromJson(json, CLASS_CHAT_COMPONENT);
    ...
    static {
        ...
        CLASS_JSON_DESERIALIZER = MinecraftReflection.findClass((String[])new String[]{"com.goo".concat("gle.gson.JsonDeserializer")});
        CLASS_JSON_ELEMENT = MinecraftReflection.findClass((String[])new String[]{"com.goo".concat("gle.gson.JsonElement")});
        CLASS_JSON_PARSER = MinecraftReflection.findClass((String[])new String[]{"com.goo".concat("gle.gson.JsonParser")});
        ...
        PARSE_JSON = MinecraftReflection.findMethod(CLASS_JSON_PARSER, (String)"parse", CLASS_JSON_ELEMENT, (Class[])new Class[]{String.class});
        GET_REGISTRY = MinecraftReflection.findStaticMethod(CLASS_CRAFT_REGISTRY, (String)"getMinecraftRegistry", CLASS_REGISTRY_ACCESS, (Class[])new Class[0]);
        ...
        try {
            ...
            if (CLASS_CHAT_COMPONENT != null) {
                ...
                Class chatSerializerClass = Arrays.stream(CLASS_CHAT_COMPONENT.getClasses()).filter(c -> {
                    ...
                    return false;
                }).findAny().orElse(MinecraftReflection.findNmsClass((String)"ChatSerializer"));
