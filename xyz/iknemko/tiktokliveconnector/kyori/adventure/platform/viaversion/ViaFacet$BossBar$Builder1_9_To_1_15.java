...
public static class ViaFacet.BossBar.Builder1_9_To_1_15<V>
extends ViaFacet<V>
implements Facet.BossBar.Builder<V, Facet.BossBar<V>> {
    public ViaFacet.BossBar.Builder1_9_To_1_15(@NotNull Class<? extends V> viewerClass, @NotNull Function<V, UserConnection> connectionFunction) {
    ...
    public // Could not load outer class - annotation placement on inner may be incorrect
     @NotNull Facet.BossBar<V> createBossBar(@NotNull Collection<V> viewer) {
        return new ViaFacet.BossBar("1_9", "1_8", this.viewerClass, arg_0 -> ((ViaFacet.BossBar.Builder1_9_To_1_15)this).findConnection(arg_0), viewer, null);
    }
}
