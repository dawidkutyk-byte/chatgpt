...
extends StringEntity {
    ...
    public UrlEncodedFormEntity(Iterable<? extends NameValuePair> parameters, Charset charset) {
        super(URLEncodedUtils.format(parameters, (Charset)(charset != null ? charset : HTTP.DEF_CONTENT_CHARSET)), ContentType.create((String)"application/x-www-form-urlencoded", (Charset)charset));
    }

    public UrlEncodedFormEntity(List<? extends NameValuePair> parameters, String charset) throws UnsupportedEncodingException {
        super(URLEncodedUtils.format(parameters, (String)(charset != null ? charset : HTTP.DEF_CONTENT_CHARSET.name())), ContentType.create((String)"application/x-www-form-urlencoded", (String)charset));
    }
}
