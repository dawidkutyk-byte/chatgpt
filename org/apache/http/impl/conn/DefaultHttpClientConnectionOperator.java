        ...
        while (i < addresses.length) {
            ...
            block15: {
                ...
                try {
                    ...
                    if (last) {
                        throw new ConnectTimeoutException((IOException)ex, host, addresses);
                    }
                }
                catch (ConnectException ex) {
                    if (last) {
                        String msg = ex.getMessage();
                        throw "Connection timed out".equals(msg) ? new ConnectTimeoutException((IOException)ex, host, addresses) : new HttpHostConnectException((IOException)ex, host, addresses);
                    }
                }
