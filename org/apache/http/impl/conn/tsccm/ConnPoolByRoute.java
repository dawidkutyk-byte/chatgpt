...
extends AbstractConnPool {
     ...
     */
    protected BasicPoolEntry getEntryBlocking(HttpRoute route, Object state, long timeout, TimeUnit timeUnit, WaitingThreadAborter aborter) throws InterruptedException, ConnectionPoolTimeoutException {
        Date deadline = null;
        if (timeout > 0L) {
        ...
        try {
            ...
            while (entry == null) {
                ...
                if ((entry = this.getFreeEntry(rospl, state)) != null) return entry;
                ...
                if (!success && deadline != null && deadline.getTime() <= System.currentTimeMillis()) throw new ConnectionPoolTimeoutException("Timeout waiting for connection from pool");
            }
            return entry;
        }
        finally {
    ...
    public ConnPoolByRoute(ClientConnectionOperator operator, HttpParams params) {
        this(operator, ConnManagerParams.getMaxConnectionsPerRoute((HttpParams)params), ConnManagerParams.getMaxTotalConnections((HttpParams)params));
    }
    ...
    protected RouteSpecificPool getRoutePool(HttpRoute route, boolean create) {
        ...
        try {
            ...
            if (rospl != null) return rospl;
            if (!create) return rospl;
    ...
    static /* synthetic */ Lock access$000(ConnPoolByRoute x0) {
        return x0.poolLock;
    }
