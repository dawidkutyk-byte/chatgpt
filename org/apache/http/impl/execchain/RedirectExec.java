    ...
    public CloseableHttpResponse execute(HttpRoute route, HttpRequestWrapper request, HttpClientContext context, HttpExecutionAware execAware) throws IOException, HttpException {
        ...
        while (true) {
            ...
            try {
                ...
                if (!this.redirectStrategy.isRedirected(currentRequest.getOriginal(), (HttpResponse)response, (HttpContext)context)) return response;
                ...
                ++redirectCount;
                HttpUriRequest redirect = this.redirectStrategy.getRedirect(currentRequest.getOriginal(), (HttpResponse)response, (HttpContext)context);
                if (!redirect.headerIterator().hasNext()) {
                    HttpRequest original = request.getOriginal();
                    redirect.setHeaders(original.getAllHeaders());
                }
                if ((currentRequest = HttpRequestWrapper.wrap((HttpRequest)redirect)) instanceof HttpEntityEnclosingRequest) {
                    RequestEntityProxy.enhance((HttpEntityEnclosingRequest)((HttpEntityEnclosingRequest)currentRequest));
                }
                if ((newTarget = URIUtils.extractHost((URI)(uri = currentRequest.getURI()))) == null) {
