    ...
    public URI getLocationURI(HttpResponse response, HttpContext context) throws ProtocolException {
        ...
        if (!uri.isAbsolute()) {
            ...
            try {
                ...
                URI absoluteRequestURI = URIUtils.rewriteURI((URI)requestURI, (HttpHost)target, (EnumSet)URIUtils.DROP_FRAGMENT_AND_NORMALIZE);
        ...
        if (!params.isParameterFalse("http.protocol.allow-circular-redirects")) return uri;
        ...
        if (uri.getFragment() != null) {
            try {
                ...
                redirectURI = URIUtils.rewriteURI((URI)uri, (HttpHost)target, (EnumSet)URIUtils.DROP_FRAGMENT_AND_NORMALIZE);
            }
            catch (URISyntaxException ex) {
                throw new ProtocolException(ex.getMessage(), (Throwable)ex);
            }
