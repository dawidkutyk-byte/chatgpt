...
implements CommonCookieAttributeHandler {
    ...
    public void validate(Cookie cookie, CookieOrigin origin) throws MalformedCookieException {
        ...
        if (cookie instanceof ClientCookie && ((ClientCookie)cookie).containsAttribute("domain")) {
            ...
            if (effectiveHostWithoutDomain.indexOf(46) == -1) return;
        ...
        if (cookie.getDomain().equals(host)) return;
    ...
    public boolean match(Cookie cookie, CookieOrigin origin) {
        ...
        if (this.domainMatch(host, cookieDomain)) String effectiveHostWithoutDomain;
        return (effectiveHostWithoutDomain = host.substring(0, host.length() - cookieDomain.length())).indexOf(46) == -1;
        return false;
    }
}
