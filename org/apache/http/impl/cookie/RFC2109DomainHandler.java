...
implements CommonCookieAttributeHandler {
    public boolean match(Cookie cookie, CookieOrigin origin) {
        ...
        if (domain != null) return host.equals(domain) || domain.startsWith(".") && host.endsWith(domain);
        return false;
    }
    ...
    public void validate(Cookie cookie, CookieOrigin origin) throws MalformedCookieException {
        ...
        if (dotIndex < 0) throw new CookieRestrictionViolationException("Domain attribute \"" + domain + "\" violates RFC 2109: domain must contain an embedded dot");
        ...
        if (hostWithoutDomain.indexOf(46) == -1) return;
