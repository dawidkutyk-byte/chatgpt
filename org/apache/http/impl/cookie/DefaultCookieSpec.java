...
implements CookieSpec {
    ...
    public boolean match(Cookie cookie, CookieOrigin origin) {
        Args.notNull((Object)cookie, (String)"Cookie");
        Args.notNull((Object)origin, (String)"Cookie origin");
        if (cookie.getVersion() <= 0) return this.netscapeDraft.match(cookie, origin);
    ...
    public List<Header> formatCookies(List<Cookie> cookies) {
        ...
        if (version <= 0) return this.netscapeDraft.formatCookies(cookies);
    ...
    public List<Cookie> parse(Header header, CookieOrigin origin) throws MalformedCookieException {
        ...
        if (!netscape && versioned) return "Set-Cookie2".equals(header.getName()) ? this.strict.parse(hElems, origin) : this.obsoleteStrict.parse(hElems, origin);
