...
public class ServerBootstrap {
    ...
    public HttpServer create() {
        ...
        if ((exceptionLoggerCopy = this.exceptionLogger) != null) return new HttpServer(this.listenerPort > 0 ? this.listenerPort : 0, this.localAddress, this.socketConfig != null ? this.socketConfig : SocketConfig.DEFAULT, serverSocketFactoryCopy, httpService, (HttpConnectionFactory)connectionFactoryCopy, this.sslSetupHandler, exceptionLoggerCopy);
        exceptionLoggerCopy = ExceptionLogger.NO_OP;
        return new HttpServer(this.listenerPort > 0 ? this.listenerPort : 0, this.localAddress, this.socketConfig != null ? this.socketConfig : SocketConfig.DEFAULT, serverSocketFactoryCopy, httpService, (HttpConnectionFactory)connectionFactoryCopy, this.sslSetupHandler, exceptionLoggerCopy);
    }
