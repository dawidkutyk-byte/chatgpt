...
implements HttpRouteDirector {
    ...
    protected int directStep(RouteInfo plan, RouteInfo fact) {
        ...
        if (plan.getLocalAddress() == null) return 0;
        if (plan.getLocalAddress().equals(fact.getLocalAddress())) return 0;
        return -1;
    }
    ...
    protected int proxiedStep(RouteInfo plan, RouteInfo fact) {
        ...
        if (plan.isSecure() == fact.isSecure()) return 0;
        return -1;
    }
