...
SocketFactory {
    ...
    @Deprecated
    public Socket connectSocket(Socket socket, String host, int port, InetAddress localAddress, int localPort, HttpParams params) throws ConnectTimeoutException, IOException, UnknownHostException {
