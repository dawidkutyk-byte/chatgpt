...
public final class Scheme {
    ...
    public final SocketFactory getSocketFactory() {
        if (!(this.socketFactory instanceof SchemeSocketFactoryAdaptor)) return this.layered ? new LayeredSocketFactoryAdaptor((LayeredSchemeSocketFactory)this.socketFactory) : new SocketFactoryAdaptor(this.socketFactory);
