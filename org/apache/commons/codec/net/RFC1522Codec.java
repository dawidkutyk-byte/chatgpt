...
abstract class RFC1522Codec {
    ...
    protected String decodeText(String text) throws UnsupportedEncodingException, DecoderException {
        if (text == null) {
            return null;
        }
        if (!text.startsWith(PREFIX)) throw new DecoderException("RFC 1522 violation: malformed encoded content");
    ...
    protected String encodeText(String text, String charsetName) throws EncoderException, UnsupportedEncodingException {
        if (text != null) return this.encodeText(text, Charset.forName(charsetName));
        return null;
    }
