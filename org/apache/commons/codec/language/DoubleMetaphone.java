...
implements StringEncoder {
    ...
    private boolean conditionC0(String value, int index) {
        ...
        if (DoubleMetaphone.contains(value, index - 1, 3, "ACH")) char c;
        return (c = this.charAt(value, index + 2)) != 'I' && c != 'E' || DoubleMetaphone.contains(value, index - 2, 6, "BACHER", "MACHER");
        return false;
    }
    ...
    private boolean conditionM0(String value, int index) {
        if (this.charAt(value, index + 1) != 'M') return DoubleMetaphone.contains(value, index - 1, 3, "UMB") && (index + 1 == value.length() - 1 || DoubleMetaphone.contains(value, index + 2, 2, "ER"));
        return true;
    }
