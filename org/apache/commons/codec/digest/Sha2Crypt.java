...
public class Sha2Crypt {
    ...
    public static String sha512Crypt(byte[] keyBytes, String salt) {
        if (salt != null) return Sha2Crypt.sha2Crypt(keyBytes, salt, SHA512_PREFIX, 64, "SHA-512");
    ...
    public static String sha256Crypt(byte[] keyBytes, String salt) {
        if (salt != null) return Sha2Crypt.sha2Crypt(keyBytes, salt, SHA256_PREFIX, 32, "SHA-256");
