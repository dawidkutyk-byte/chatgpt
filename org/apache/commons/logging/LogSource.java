...
public class LogSource {
    ...
    public static void setLogImplementation(Class logclass) throws NoSuchMethodException, ExceptionInInitializerError, SecurityException, LinkageError {
    ...
    public static void setLogImplementation(String classname) throws ClassNotFoundException, SecurityException, NoSuchMethodException, LinkageError {
        try {
