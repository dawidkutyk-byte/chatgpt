...
extends LogFactory {
    ...
    private void initDiagnostics() {
        ...
        try {
            classLoaderName = classLoader == null ? "BOOTLOADER" : LogFactoryImpl.objectId((Object)classLoader);
        }
        catch (SecurityException e) {
            classLoaderName = "UNKNOWN";
        }
        this.diagnosticPrefix = new StringBuffer().append("[LogFactoryImpl@").append(System.identityHashCode((Object)this)).append(" from ").append(classLoaderName).append("] ").toString();
    }
    ...
    protected String getLogClassName() {
        ...
        this.discoverLogImplementation(((Object)((Object)this)).getClass().getName());
        ...
        if (implementsLog) {
            if (LogFactoryImpl.isDiagnosticsEnabled()) {
                try {
                    ...
                    this.logDiagnostic(new StringBuffer().append("Class '").append(badClass.getName()).append("' was found in classloader ").append(LogFactoryImpl.objectId((Object)badClassLoader)).append(". It is bound to a Log interface which is not").append(" the one loaded from classloader ").append(LogFactoryImpl.objectId((Object)logInterfaceClassLoader)).toString());
                }
                catch (Throwable t) {
                    LogFactoryImpl.handleThrowable((Throwable)t);
    ...
    private Log createLogFromClass(String logAdapterClassName, String logCategory, boolean affectState) throws LogConfigurationException {
        ...
        while (true) {
            String msg;
            this.logDiagnostic(new StringBuffer().append("Trying to load '").append(logAdapterClassName).append("' from classloader ").append(LogFactoryImpl.objectId((Object)currentCL)).toString());
            try {
                Class<?> c;
                if (LogFactoryImpl.isDiagnosticsEnabled()) {
                ...
                try {
                    ...
                    this.logDiagnostic(new StringBuffer().append("The log adapter '").append(logAdapterClassName).append("' is not available via classloader ").append(LogFactoryImpl.objectId((Object)currentCL)).append(": ").append(msg2.trim()).toString());
                    try {
                ...
                msg = e.getMessage();
                this.logDiagnostic(new StringBuffer().append("The log adapter '").append(logAdapterClassName).append("' is missing dependencies when loaded via classloader ").append(LogFactoryImpl.objectId((Object)currentCL)).append(": ").append(msg.trim()).toString());
                break;
            }
            catch (ExceptionInInitializerError e) {
                msg = e.getMessage();
                this.logDiagnostic(new StringBuffer().append("The log adapter '").append(logAdapterClassName).append("' is unable to initialize itself when loaded via classloader ").append(LogFactoryImpl.objectId((Object)currentCL)).append(": ").append(msg.trim()).toString());
                break;
            }
        ...
        try {
            ...
            LogFactoryImpl.handleThrowable((Throwable)t);
            this.logMethod = null;
            this.logDiagnostic(new StringBuffer().append("[INFO] '").append(logAdapterClassName).append("' from classloader ").append(LogFactoryImpl.objectId((Object)currentCL)).append(" does not declare optional method ").append("setLogFactory(LogFactory)").toString());
        }
        this.logDiagnostic(new StringBuffer().append("Log adapter '").append(logAdapterClassName).append("' from classloader ").append(LogFactoryImpl.objectId((Object)logAdapterClass.getClassLoader())).append(" has been selected for use.").toString());
        return logAdapter;
    }
    ...
    private boolean isLogLibraryAvailable(String name, String classname) {
        ...
        try {
            Log log = this.createLogFromClass(classname, ((Object)((Object)this)).getClass().getName(), false);
            if (log == null) {
    ...
    static {
        PKG_LEN = PKG_IMPL.length();
        classesToDiscover = new String[]{LOGGING_IMPL_LOG4J_LOGGER, LOGGING_IMPL_JDK14_LOGGER, LOGGING_IMPL_LUMBERJACK_LOGGER, LOGGING_IMPL_SIMPLE_LOGGER};
    }
    ...
    public LogFactoryImpl() {
        ...
        this.logConstructorSignature = new Class[]{class$java$lang$String == null ? (class$java$lang$String = LogFactoryImpl.class$("java.lang.String")) : class$java$lang$String};
        this.logMethodSignature = new Class[]{class$org$apache$commons$logging$LogFactory == null ? (class$org$apache$commons$logging$LogFactory = LogFactoryImpl.class$("org.apache.commons.logging.LogFactory")) : class$org$apache$commons$logging$LogFactory};
    ...
    protected static ClassLoader getClassLoader(Class clazz) {
        return LogFactory.getClassLoader((Class)clazz);
    }
    ...
    protected void logDiagnostic(String msg) {
        if (!LogFactoryImpl.isDiagnosticsEnabled()) return;
        LogFactoryImpl.logRawDiagnostic((String)new StringBuffer().append(this.diagnosticPrefix).append(msg).toString());
    }
}
