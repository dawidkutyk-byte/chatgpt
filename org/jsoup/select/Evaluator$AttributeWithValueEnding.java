...
public static final class Evaluator.AttributeWithValueEnding
extends Evaluator.AttributeKeyPair {
    public boolean matches(Element root, Element element) {
        return element.hasAttr(this.key) && Normalizer.lowerCase((String)element.attr(this.key)).endsWith(this.value);
    }
